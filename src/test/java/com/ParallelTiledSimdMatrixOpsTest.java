...
class ParallelTiledSimdMatrixOpsTest {
    ...
    void multiply_knownValue() {
        ...
        float[][] result = parallelTiled.multiply(a, b);
    ...
    void multiply_identityReturnsOriginal() {
        ...
        float[][] result = parallelTiled.multiply(a, id);
    ...
    @ParameterizedTest
    @ValueSource(ints = {1, 2, 7, 16, 33, 64, 65, 100, 129, 260})
    ...
    void multiply_mismatchedDimensions_throws() {
        float[][] a = {{1, 2, 3}, {4, 5, 6}};
        float[][] b = {{1, 2}, {3, 4}};
        assertThrows(IllegalArgumentException.class, () -> parallelTiled.multiply(a, b));
    }
}

...
import com.performance.BlockedCholeskySweep;
...
public class BlockedCholeskyBenchmark {
    ...
    public void setup() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            a[i][i] = size + rng.nextFloat();
        }
    }

    @Benchmark
    public void blocked_cholesky(Blackhole bh) {
        bh.consume(blocked.cholesky(a, blockSize));
    }
    ...
    public static void main(String[] args)
        ...
        Options opt = new OptionsBuilder()
                .include(BlockedCholeskyBenchmark.class.getSimpleName())
                .build();
